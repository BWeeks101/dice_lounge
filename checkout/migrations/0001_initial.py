    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sub_product_line', models.CharField(max_length=254)),
                ('product_line', models.CharField(max_length=254)),
                ('quantity', models.IntegerField(default=0)),
                ('item_price', models.DecimalField(decimal_places=2, default=0.0, max_digits=6)),
                ('lineitem_total', models.DecimalField(decimal_places=2, default=0.0, max_digits=6)),
