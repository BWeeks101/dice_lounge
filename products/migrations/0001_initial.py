# Generated by Django 3.2.4 on 2021-07-30 20:18
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='Please enter a descriptive name for this Category.              Must be unique.', max_length=254, unique=True, verbose_name='Category')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='Please enter a descriptive name for this Genre.              Must be unique.', max_length=254, unique=True, verbose_name='Genre')),
            ],
        ),
        migrations.CreateModel(
            name='Product_Line',
            fields=[
                ...
                ('name', models.CharField(help_text='Please enter a descriptive name for this Product Line.                  Must be unique.', max_length=254, unique=True, verbose_name='Product Line')),
                ('description', models.TextField(blank=True, help_text='Please enter a description for this Product Line.', max_length=500, null=True)),
                ('image', models.ImageField(blank=True, help_text='(Optional) Please add an image for this Product Line.', max_length=2000, null=True, upload_to=products.models.product_line_image_path)),
                ('hidden', models.BooleanField(default=False, help_text='Hide this Product Line (and all child Sub Product Lines and             Products) from view?')),
                ('category', models.ForeignKey(help_text='Please select a category for this Product Line.', on_delete=django.db.models.deletion.RESTRICT, to='products.category')),
                ('genre', models.ForeignKey(help_text='Please select a genre for this Product Line.', on_delete=django.db.models.deletion.RESTRICT, to='products.genre')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(help_text='Please enter a descriptive name for this Publisher.              Must be unique.', max_length=254, unique=True, verbose_name='Publisher')),
            ],
        ),
        migrations.CreateModel(
            name='Reduced_Reason',
            fields=[
                ...
                ('reason', models.CharField(help_text='Please enter a descriptive name for this Reduced Price Reason.                  Must be unique.', max_length=254, unique=True, verbose_name='Reduced Price Reason')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.CharField(help_text='Please enter a descriptive name for this Stock State.              Must be unique.', max_length=254, unique=True, verbose_name='Stock State')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, help_text='Please enter a description for this Sub Product Line', max_length=500, null=True)),
                ...
                ('image', models.ImageField(blank=True, help_text='(Optional) Please add an image for this Sub Product Line.', max_length=2000, null=True, upload_to=products.models.sub_product_line_image_path)),
                ('hidden', models.BooleanField(default=False, help_text='Hide this Sub Product Line (and all child Products) from             view?')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, help_text='Please enter a description for this Product.', max_length=500, null=True)),
                ('image', models.ImageField(blank=True, help_text='(Optional) Please add an image for this Product.', max_length=2000, null=True, upload_to=products.models.product_image_path)),
                ...
                ('hidden', models.BooleanField(default=False, help_text='Hide this Product from view?')),
                ('reduced_reason', models.ForeignKey(blank=True, help_text='Why is this product reduced?', null=True, on_delete=django.db.models.deletion.RESTRICT, to='products.reduced_reason', verbose_name='Reason for Reduction')),
                ('stock_state', models.ForeignKey(default=2, help_text='What is the stock status of this product?', null=True, on_delete=django.db.models.deletion.RESTRICT, to='products.stock_state', verbose_name='Stock State')),
