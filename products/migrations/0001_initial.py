    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('max_per_purchase', models.IntegerField(default=10, help_text='Please enter the max number of units (1-10) available to a single purchase', validators=[django.core.validators.MinValueValidator(1), django.core.validators.MaxValueValidator(10)])),
